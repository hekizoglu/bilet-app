...
export function HallSettingsPanel() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Buton */}
      <button className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 rounded-lg font-bold hover:shadow-lg transition flex items-center justify-center gap-2">
