...
* **FAZ 5 (Davet ve Katılım Yönetimi):** RSVP sistemi ön ve arka yüzde tamamlandı. Organizatörlerin davetlileri görebilmesi için `dashboard/reservations/page.tsx` sayfasına İstatistik Kartları, RSVP Filtresi ve yeni tablo sütunları (RSVP durumu, Notlar, Misafir sayısı) eklendi.
